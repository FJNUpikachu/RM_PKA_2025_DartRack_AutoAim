...
NODE_NAMES=("dart_detector dart_solver" "dart_serial" "dart_camera")  # 监控的节点名称列表
USER="$(whoami)"  # 获取当前用户名
HOME_DIR=$(eval echo ~$USER)  # 用户主目录：记得改！
WORKING_DIR="$HOME_DIR/"  # 代码工作目录
LAUNCH_FILE="dart_bringup bringup.launch.py"  # launch文件路径
